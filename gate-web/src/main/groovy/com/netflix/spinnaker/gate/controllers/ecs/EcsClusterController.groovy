...
class EcsClusterController {
  ...
  @RequestMapping(value = "/ecs/ecsClusterDescriptions", method = RequestMethod.GET)
  List getEcsClusterDescriptions(@RequestParam("account") String account, @RequestParam("region") String region) {
